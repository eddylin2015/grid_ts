...
class es_datagrid {
    ...
    private tbl: any;
    public constructor(_jsondata: any, _tbl: string) {
    ...
    public static editCell(cell: any) {
    ...
    public static bind_txtinput_paste($txtinput, cell) {
    ...
    public head_click(headid) {
        $("#" + headid).click(function(event) {
            ...
            if (input_first != null) input_first.focus();
    ...
    public BindingFunctions(editbtn, savebtn, readmodbtn) {
        ...
        $('#' + savebtn).click(function(event) {
            ...
            alert(posturl);
            if (posturl != null) {
                $.post(posturl, { datajson: json, keycode: '125678985432' }
                    , function(data) {
